...
set(RPI_CPP_TOOLCHAIN_TRIPLE "armv8-rpi3-linux-gnueabihf")

# Path to find compilers and other tools
set(RPI_CPP_TOOLCHAIN_TOOLCHAIN_PATHS
    "${CMAKE_CURRENT_LIST_DIR}/../.toolchains/x-tools/${RPI_CPP_TOOLCHAIN_TRIPLE}/bin")
...
# Find the sysroot
set(CMAKE_SYSROOT 
    "${CMAKE_CURRENT_LIST_DIR}/../.toolchains/sysroot/${RPI_CPP_TOOLCHAIN_TRIPLE}")
